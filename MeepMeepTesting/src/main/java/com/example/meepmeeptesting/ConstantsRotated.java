...
public final class ConstantsRotated {
  ...
  public static Pose2d RED_BACKSTAGE_PARK_POSE = new Pose2d(2*TILE, -TILE*2-HALF_TILE, FACE_TOWARD_BACKSTAGE);
  public static Pose2d BLUE_BACKSTAGE_PARK_POSE = new Pose2d(2*TILE, TILE*2+HALF_TILE, FACE_TOWARD_BACKSTAGE);
