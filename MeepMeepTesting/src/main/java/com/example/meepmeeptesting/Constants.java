...
//  public static Pose2d RED_AUDIENCE_SPIKE_L_DROP = new Pose2d(-TILE-THREE_QUARTER_TILE-1.5, -TILE-HALF_TILE-6.5, Math.toRadians(115));
  ...
  public static Pose2d SUPER_RED_NEUTRAL_PIXEL_STAGEDOOR_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_PIXEL_STACK_FROM_STAGING + HALF_ROBOT_LENGTH, -11.656, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_STAGEDOOR_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_PIXEL_STACK_FROM_STAGING + HALF_ROBOT_LENGTH, 11.656, FACE_TOWARD_BACKSTAGE);
