...
public final class Constants {
  ...
  public static RobotType getRobot() {
    ...
    public static Pose2d BLUE_BACKSTAGE_START_POSE = new Pose2d(-HALF_FIELD + HALF_ROBOT_LENGTH,HALF_TILE, FACE_TOWARD_RED);
    public static Pose2d BLUE_AUDIENCE_START_POSE = new Pose2d(-HALF_FIELD + HALF_ROBOT_LENGTH, -HALF_TILE-TILE, FACE_TOWARD_RED);
    public static Pose2d RED_BACKSTAGE_START_POSE = new Pose2d(HALF_FIELD - HALF_ROBOT_LENGTH, HALF_TILE, FACE_TOWARD_BLUE);
    public static Pose2d RED_AUDIENCE_START_POSE = new Pose2d(+HALF_FIELD - HALF_ROBOT_LENGTH,-HALF_TILE - TILE, FACE_TOWARD_BLUE);
    ...
    public static Pose2d RED_AUDIENCE_SPIKE_R = new Pose2d(TILE+HALF_TILE,-TILE-QUARTER_TILE, FACE_135_DEGREES);
    public static Pose2d RED_AUDIENCE_SPIKE_C = new Pose2d(TILE+HALF_TILE, -TILE-HALF_TILE, FACE_TOWARD_BLUE);
    public static Pose2d RED_AUDIENCE_SPIKE_L = new Pose2d(TILE+HALF_TILE, -TILE-THREE_QUARTER_TILE, FACE_225_DEGREES);

    public static Pose2d BLUE_AUDIENCE_SPIKE_L =  new Pose2d(-TILE-HALF_TILE,-TILE-QUARTER_TILE, FACE_45_DEGREES);
    ...
    public static Pose2d RED_STAGEDOOR_ENTRANCE = new Pose2d(HALF_TILE,-QUARTER_TILE-TILE, FACE_TOWARD_BACKSTAGE);
    public static Pose2d BLUE_STAGEDOOR_ENTRANCE =new Pose2d(-HALF_TILE,-QUARTER_TILE-TILE, FACE_TOWARD_BACKSTAGE);
