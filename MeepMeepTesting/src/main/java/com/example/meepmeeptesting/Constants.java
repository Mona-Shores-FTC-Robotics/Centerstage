...
public final class Constants {
  ...
  public static Pose2d BLUE_BACKSTAGE_SPIKE_C_PAST = new Pose2d(HALF_TILE+3, TILE+QUARTER_TILE, FACE_TOWARD_RED);
  public static Pose2d BLUE_BACKSTAGE_SPIKE_C_DROP = new Pose2d(HALF_TILE+3, TILE+QUARTER_TILE+4, FACE_TOWARD_RED);

  public static Pose2d BLUE_AUDIENCE_SPIKE_C = new Pose2d(-TILE-HALF_TILE, TILE+HALF_TILE-2, FACE_TOWARD_RED);
  public static Pose2d BLUE_AUDIENCE_SPIKE_C_PAST = new Pose2d(-TILE-HALF_TILE+3, TILE+QUARTER_TILE, FACE_TOWARD_RED);
  public static Pose2d BLUE_AUDIENCE_SPIKE_C_DROP = new Pose2d(-TILE-HALF_TILE+3, TILE+QUARTER_TILE+4, FACE_TOWARD_RED);

//Left Prop
  public static Pose2d RED_BACKSTAGE_SPIKE_L = new Pose2d(TILE-THREE_QUARTER_TILE+2, -TILE-HALF_TILE, FACE_135_DEGREES);
  public static Pose2d RED_BACKSTAGE_SPIKE_L_PAST = new Pose2d(TILE-THREE_QUARTER_TILE+2, -TILE-HALF_TILE, FACE_135_DEGREES);
  public static Pose2d RED_BACKSTAGE_SPIKE_L_DROP = new Pose2d(TILE-THREE_QUARTER_TILE+2, -TILE-HALF_TILE, FACE_135_DEGREES);

  public static Pose2d RED_AUDIENCE_SPIKE_L = new Pose2d(-TILE-THREE_QUARTER_TILE+4, -TILE-HALF_TILE, FACE_135_DEGREES);
  public static Pose2d RED_AUDIENCE_SPIKE_L_PAST = new Pose2d(-TILE-THREE_QUARTER_TILE-10, -TILE-2, FACE_TOWARD_BACKSTAGE);
  public static Pose2d RED_AUDIENCE_SPIKE_L_DROP = new Pose2d(-TILE-THREE_QUARTER_TILE-15, -TILE-2, FACE_TOWARD_BACKSTAGE);

  public static Pose2d BLUE_BACKSTAGE_SPIKE_L = new Pose2d(TILE-QUARTER_TILE-2, TILE+HALF_TILE, FACE_315_DEGREES);
  public static Pose2d BLUE_BACKSTAGE_SPIKE_L_PAST = new Pose2d(TILE-QUARTER_TILE-2, TILE+HALF_TILE, FACE_315_DEGREES);
  public static Pose2d BLUE_BACKSTAGE_SPIKE_L_DROP = new Pose2d(TILE-QUARTER_TILE-2, TILE+HALF_TILE, FACE_315_DEGREES);

  public static Pose2d BLUE_AUDIENCE_SPIKE_L = new Pose2d(-TILE-QUARTER_TILE-2, TILE+HALF_TILE, FACE_315_DEGREES);
  public static Pose2d BLUE_AUDIENCE_SPIKE_L_PAST = new Pose2d(-TILE-QUARTER_TILE-2, TILE+HALF_TILE, FACE_315_DEGREES);
  public static Pose2d BLUE_AUDIENCE_SPIKE_L_DROP = new Pose2d(-TILE-QUARTER_TILE-2, TILE+HALF_TILE, FACE_315_DEGREES);

  //Spike Right
  public static Pose2d RED_BACKSTAGE_SPIKE_R = new Pose2d(TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
  public static Pose2d RED_BACKSTAGE_SPIKE_R_PAST = new Pose2d(TILE-QUARTER_TILE, -TILE-HALF_TILE+4, Math.toRadians(55));
  public static Pose2d RED_BACKSTAGE_SPIKE_R_DROP = new Pose2d(TILE-QUARTER_TILE-.5, -TILE-HALF_TILE-4, Math.toRadians(55));
  ...
  public static Pose2d BLUE_BACKSTAGE_SPIKE_R_PAST = new Pose2d(TILE-THREE_QUARTER_TILE-1, TILE+HALF_TILE-1, FACE_225_DEGREES);
  public static Pose2d BLUE_BACKSTAGE_SPIKE_R_DROP = new Pose2d(TILE-THREE_QUARTER_TILE+1, TILE+HALF_TILE+1, FACE_225_DEGREES);

  public static Pose2d BLUE_AUDIENCE_SPIKE_R = new Pose2d(-TILE-THREE_QUARTER_TILE+4, TILE+HALF_TILE, FACE_225_DEGREES);
  public static Pose2d BLUE_AUDIENCE_SPIKE_R_PAST = new Pose2d(-TILE-THREE_QUARTER_TILE-10, TILE+2, FACE_TOWARD_BACKSTAGE);
  public static Pose2d BLUE_AUDIENCE_SPIKE_R_DROP = new Pose2d(-TILE-THREE_QUARTER_TILE-15, TILE+2, FACE_TOWARD_BACKSTAGE);
