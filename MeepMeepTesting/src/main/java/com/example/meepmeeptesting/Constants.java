...
//  public static Pose2d RED_AUDIENCE_SPIKE_L_DROP = new Pose2d(-TILE-THREE_QUARTER_TILE-1.5, -TILE-HALF_TILE-6.5, Math.toRadians(115));
  ...
  public static Pose2d RED_NEUTRAL_PIXEL_CENTERSPIKE_PICKUP = new Pose2d(-64.281 + HALF_ROBOT_LENGTH-DISTANCE_TO_PIXEL_STACK_FROM_STAGING-4, -23.469, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d BLUE_NEUTRAL_PIXEL_CENTERSPIKE_PICKUP = new Pose2d(-64.281 + HALF_ROBOT_LENGTH-DISTANCE_TO_PIXEL_STACK_FROM_STAGING-4, 23.469, FACE_TOWARD_BACKSTAGE);
