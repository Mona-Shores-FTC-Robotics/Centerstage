...
public final class Constants {
  ...
  public static Pose2d SUPER_RED_NEUTRAL_PIXEL_STAGEDOOR_PICKUP = new Pose2d(-2*TILE-QUARTER_TILE-8 + HALF_ROBOT_LENGTH,-11.656, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_STAGEDOOR_PICKUP = new Pose2d(-2*TILE-QUARTER_TILE-8 + HALF_ROBOT_LENGTH,11.656, FACE_TOWARD_BACKSTAGE);
