...
//  public static Pose2d RED_BACKDROP_STAGING = new Pose2d(2*TILE-5, -35.264, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d BLUE_OFFSET_NEUTRAL_PIXEL_STAGING = new Pose2d(-2 * TILE - QUARTER_TILE - 5, 34.969 + 2, FACE_TOWARD_BACKSTAGE);
  public static Pose2d RED_OFFSET_NEUTRAL_PIXEL_STAGING = new Pose2d(-2 * TILE - QUARTER_TILE - 5, -34.969 - 2, FACE_TOWARD_BACKSTAGE);
  ...
  //these look wrong... the y value probably shouldnt be +1.5
  public static Pose2d BLUE_NEUTRAL_PIXEL_TRUSS = new Pose2d(-TILE * 2 - HALF_TILE -  DISTANCE_TO_PIXEL_STACK_FROM_STAGING, TILE + HALF_TILE + 1.5, FACE_TOWARD_BACKSTAGE);
  public static Pose2d BLUE_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_PIXEL_STACK_FROM_STAGING, TILE + HALF_TILE + 1.5, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d SUPER_RED_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_PIXEL_STACK_FROM_STAGING, -34.969, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_TRUSS = new Pose2d(-2 * TILE - QUARTER_TILE - 5, 34.969, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_PIXEL_STACK_FROM_STAGING, 34.969, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d SUPER_RED_NEUTRAL_PIXEL_STAGEDOOR_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE-DISTANCE_TO_PIXEL_STACK_FROM_STAGING, -11.656, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_STAGEDOOR_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE-DISTANCE_TO_PIXEL_STACK_FROM_STAGING, 11.656, FACE_TOWARD_BACKSTAGE);
