...
public class TurnIntakeSuperSlow implements Action {

    public TurnIntakeSuperSlow() {

    }
    @Override
    public boolean run(@NonNull TelemetryPacket telemetryPacket) {
        telemetryPacket.addLine("Intake Super Slow Action");
        ...
        intakeSubsystem.currentIntake1State = IntakeSubsystem.IntakeStates.INTAKE_SUPER_SLOW;
        intakeSubsystem.intake1.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        intakeSubsystem.intake1.setPower(intakeParameters.INTAKE_SUPER_SLOW_POWER);
