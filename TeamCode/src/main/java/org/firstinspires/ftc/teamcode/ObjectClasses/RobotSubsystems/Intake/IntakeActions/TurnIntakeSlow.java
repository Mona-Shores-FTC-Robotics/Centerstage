...
public class TurnIntakeSlow implements Action {

    public TurnIntakeSlow() {

    }
    @Override
    public boolean run(@NonNull TelemetryPacket telemetryPacket) {
        telemetryPacket.addLine("Intake Slow Action");
        ...
        intakeSubsystem.currentIntake1State = IntakeSubsystem.IntakeStates.INTAKE_SLOW;
        intakeSubsystem.intake1.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        intakeSubsystem.intake1.setPower(intakeParameters.INTAKE_SLOW_POWER);
