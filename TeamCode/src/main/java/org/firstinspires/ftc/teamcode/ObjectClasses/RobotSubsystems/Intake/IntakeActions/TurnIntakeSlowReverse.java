...
public class TurnIntakeSlowReverse implements Action {

    public TurnIntakeSlowReverse() {
    ...
    public boolean run(@NonNull TelemetryPacket telemetryPacket) {
        ...
        intakeSubsystem.intake1.setPower(intakeParameters.INTAKE_SLOW_REVERSE_POWER);
