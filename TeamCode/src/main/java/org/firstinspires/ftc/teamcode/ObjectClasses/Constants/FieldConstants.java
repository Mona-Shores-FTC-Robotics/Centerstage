...
public class FieldConstants {
  ...
  public static double DISTANCE_TO_CENTER_SPIKE_PIXEL_STACK_FROM_STAGING=7.2;
  public static double DISTANCE_TO_TRUSS_PIXEL_STACK_FROM_STAGING =2.2;
  ...
  public static Pose2d RED_MIDDLE_OF_SPIKES = new Pose2d(-TILE, -TILE-HALF_TILE, FACE_TOWARD_BACKSTAGE);
  public static Pose2d BLUE_MIDDLE_OF_SPIKES = new Pose2d(-TILE, TILE+HALF_TILE, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d BLUE_BACKDROP_CENTER = new Pose2d(2 * TILE, TILE + HALF_TILE+.5, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d UP_THE_MID_BLUE_BACKDROP_STAGING_CENTER = new Pose2d(TILE, TILE+HALF_TILE, FACE_TOWARD_BACKSTAGE);
  public static Pose2d UP_THE_MID_RED_BACKDROP_STAGING_CENTER = new Pose2d(TILE+QUARTER_TILE, -TILE-HALF_TILE, FACE_TOWARD_BACKSTAGE);

  public static Pose2d UP_THE_MID_RED_BACKDROP_RIGHT = new Pose2d(2 * TILE, -TILE - TILE + QUARTER_TILE-1.5, FACE_TOWARD_BACKSTAGE);
  public static Pose2d UP_THE_MID_RED_BACKDROP_LEFT = new Pose2d(2 * TILE, -TILE - QUARTER_TILE+1.5, FACE_TOWARD_BACKSTAGE);
  public static Pose2d UP_THE_MID_BLUE_BACKDROP_RIGHT = new Pose2d(2 * TILE, TILE + HALF_TILE - QUARTER_TILE-1.5, FACE_TOWARD_BACKSTAGE);
  public static Pose2d UP_THE_MID_BLUE_BACKDROP_LEFT = new Pose2d(2 * TILE, TILE + HALF_TILE + QUARTER_TILE+1.5, FACE_TOWARD_BACKSTAGE);
...
//  public static Pose2d RED_BACKDROP_STAGING = new Pose2d(2*TILE-5, -35.264, FACE_TOWARD_BACKSTAGE);
    public static Pose2d RED_BACKDROP_STAGING = new Pose2d(TILE, -TILE - HALF_TILE, FACE_TOWARD_BACKSTAGE);
    public static Pose2d BLUE_BACKDROP_STAGING = new Pose2d(TILE, TILE + HALF_TILE, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d RED_NEUTRAL_PIXEL_CENTERSPIKE = new Pose2d(-2 * TILE - QUARTER_TILE, -23.469+3.2, FACE_TOWARD_BACKSTAGE);
  public static Pose2d RED_NEUTRAL_PIXEL_CENTERSPIKE_PICKUP = new Pose2d(-2 * TILE - QUARTER_TILE - DISTANCE_TO_CENTER_SPIKE_PIXEL_STACK_FROM_STAGING, -23.469+3.2, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d BLUE_NEUTRAL_PIXEL_CENTERSPIKE = new Pose2d(-2 * TILE - QUARTER_TILE - 5, 23.469-3.2, FACE_TOWARD_BACKSTAGE);
  public static Pose2d BLUE_NEUTRAL_PIXEL_CENTERSPIKE_PICKUP = new Pose2d(-2 * TILE - QUARTER_TILE - 5 -  DISTANCE_TO_CENTER_SPIKE_PIXEL_STACK_FROM_STAGING, 23.469-3.2, FACE_TOWARD_BACKSTAGE);

    public static Pose2d BLUE_NEUTRAL_PIXEL_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE- DISTANCE_TO_TRUSS_PIXEL_STACK_FROM_STAGING, TILE + HALF_TILE, FACE_TOWARD_BACKSTAGE);
    public static Pose2d BLUE_NEUTRAL_PIXEL_PICKUP_TOWARD_WALL_MORE = new Pose2d(-TILE * 2 - HALF_TILE- DISTANCE_TO_TRUSS_PIXEL_STACK_FROM_STAGING -4, TILE + HALF_TILE, FACE_TOWARD_BACKSTAGE);
    public static Pose2d BLUE_NEUTRAL_STAGING = new Pose2d(-2 * TILE + 10, TILE + HALF_TILE, FACE_TOWARD_BACKSTAGE);

  public static Pose2d RED_NEUTRAL_PIXEL_TRUSS = new Pose2d(-TILE * 2 - QUARTER_TILE, -34.969+3.5, FACE_TOWARD_BACKSTAGE);
  public static Pose2d RED_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_TRUSS_PIXEL_STACK_FROM_STAGING, -34.969+3.5, FACE_TOWARD_BACKSTAGE);

  public static Pose2d BLUE_NEUTRAL_PIXEL_TRUSS = new Pose2d(-TILE * 2 - QUARTER_TILE, 34.969-3.5, FACE_TOWARD_BACKSTAGE);
  public static Pose2d BLUE_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_TRUSS_PIXEL_STACK_FROM_STAGING, 34.969-3.5, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d SUPER_RED_NEUTRAL_PIXEL_TRUSS = new Pose2d(-TILE * 2 - QUARTER_TILE, -34.969+2.8, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_RED_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_TRUSS_PIXEL_STACK_FROM_STAGING, -34.969+2.8, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_TRUSS = new Pose2d(-TILE * 2 - QUARTER_TILE, 34.969-2.8, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_TRUSS_PIXEL_STACK_FROM_STAGING, 34.969-2.8, FACE_TOWARD_BACKSTAGE);
    ...
    public static Pose2d SUPER_RED_NEUTRAL_PIXEL_STAGEDOOR = new Pose2d(-2 * TILE - QUARTER_TILE - 8 + HALF_ROBOT_LENGTH, -11.656+2, FACE_TOWARD_BACKSTAGE);
    public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_STAGEDOOR = new Pose2d(-2 * TILE - QUARTER_TILE - 8 + HALF_ROBOT_LENGTH, 11.656-2, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_RED_NEUTRAL_PIXEL_STAGEDOOR_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE-DISTANCE_TO_STAGE_DOOR_PIXEL_STACK_FROM_STAGING, -11.656+2, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_STAGEDOOR_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE-DISTANCE_TO_STAGE_DOOR_PIXEL_STACK_FROM_STAGING, 11.656-2, FACE_TOWARD_BACKSTAGE);
