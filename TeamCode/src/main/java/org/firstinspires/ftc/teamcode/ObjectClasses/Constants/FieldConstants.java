...
public class FieldConstants {
  ...
  public static double AUDIENCE_ROBOT_WAIT_TIME = 2.9;
  ...
  public static double DISTANCE_TO_CENTER_SPIKE_PIXEL_STACK_FROM_STAGING=7;
    public static double DISTANCE_TO_TRUSS_PIXEL_STACK_FROM_STAGING =2.0;
...
//  public static Pose2d RED_BACKDROP_STAGING = new Pose2d(2*TILE-5, -35.264, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d RED_NEUTRAL_PIXEL_CENTERSPIKE_PICKUP = new Pose2d(-2 * TILE - QUARTER_TILE - DISTANCE_TO_CENTER_SPIKE_PIXEL_STACK_FROM_STAGING, -23.469+3, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d BLUE_NEUTRAL_PIXEL_CENTERSPIKE = new Pose2d(-2 * TILE - QUARTER_TILE - 5, 23.469-10, FACE_TOWARD_BACKSTAGE);
  public static Pose2d BLUE_NEUTRAL_PIXEL_CENTERSPIKE_PICKUP = new Pose2d(-2 * TILE - QUARTER_TILE - 5 -  DISTANCE_TO_CENTER_SPIKE_PIXEL_STACK_FROM_STAGING, 23.469-10, FACE_TOWARD_BACKSTAGE);
