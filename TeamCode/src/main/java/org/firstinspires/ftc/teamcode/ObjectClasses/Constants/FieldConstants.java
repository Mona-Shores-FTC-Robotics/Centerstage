...
//  public static Pose2d RED_BACKDROP_RIGHT = new Pose2d(2*TILE, -41.264, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d SUPER_RED_BACKDROP_RIGHT = new Pose2d(2 * TILE, -TILE - TILE + QUARTER_TILE - 4, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_RED_BACKDROP_LEFT = new Pose2d(2 * TILE, -TILE - QUARTER_TILE+4, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_BACKDROP_RIGHT = new Pose2d(2 * TILE, TILE + HALF_TILE - QUARTER_TILE-4, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_BACKDROP_LEFT = new Pose2d(2 * TILE, TILE + HALF_TILE + QUARTER_TILE+4, FACE_TOWARD_BACKSTAGE);
