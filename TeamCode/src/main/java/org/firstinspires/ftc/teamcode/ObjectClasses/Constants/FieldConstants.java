...
//  public static Pose2d RED_BACKDROP_STAGING = new Pose2d(2*TILE-5, -35.264, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d BLUE_NEUTRAL_PIXEL_CENTERSPIKE_PICKUP = new Pose2d(-2 * TILE - QUARTER_TILE - 5 -  DISTANCE_TO_CENTER_SPIKE_PIXEL_STACK_FROM_STAGING, 23.469-3, FACE_TOWARD_BACKSTAGE);
