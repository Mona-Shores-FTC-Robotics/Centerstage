...
//  public static Pose2d RED_BACKDROP_STAGING = new Pose2d(2*TILE-5, -35.264, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d SUPER_RED_NEUTRAL_PIXEL_TRUSS = new Pose2d(-TILE * 2 - QUARTER_TILE, -34.969+2, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_RED_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_TRUSS_PIXEL_STACK_FROM_STAGING, -34.969+2, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_TRUSS = new Pose2d(-TILE * 2 - QUARTER_TILE, 34.969-2, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_TRUSS_PIXEL_STACK_FROM_STAGING, 34.969-2, FACE_TOWARD_BACKSTAGE);
