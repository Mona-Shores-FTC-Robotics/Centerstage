...
//  public static Pose2d RED_AUDIENCE_SPIKE_L_DROP = new Pose2d(-TILE-THREE_QUARTER_TILE-1.5, -TILE-HALF_TILE-6.5, Math.toRadians(115));
    ...
    public static Pose2d SUPER_RED_NEUTRAL_PIXEL_TRUSS = new Pose2d(-2 * TILE - QUARTER_TILE - 5, -34.969+3, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_RED_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_PIXEL_STACK_FROM_STAGING, -34.969+3, FACE_TOWARD_BACKSTAGE);
    public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_TRUSS = new Pose2d(-2 * TILE - QUARTER_TILE - 5, 34.969-3, FACE_TOWARD_BACKSTAGE);
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_TRUSS_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE - DISTANCE_TO_PIXEL_STACK_FROM_STAGING, 34.969-3, FACE_TOWARD_BACKSTAGE);
  ...
  public static Pose2d SUPER_BLUE_NEUTRAL_PIXEL_STAGEDOOR_PICKUP = new Pose2d(-TILE * 2 - HALF_TILE-DISTANCE_TO_PIXEL_STACK_FROM_STAGING, 11.656, FACE_TOWARD_BACKSTAGE);
    ...
    public static double SCORE_DISTANCE = 6.0;
