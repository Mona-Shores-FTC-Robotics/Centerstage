...
public class FieldConstants {
    ...
    public static Pose2d RED_BACKDROP = new Pose2d(2*TILE, -TILE-HALF_TILE, FACE_TOWARD_AUDIENCE);
    public static Pose2d RED_BACKDROP_RIGHT = new Pose2d(2*TILE, -TILE-QUARTER_TILE, FACE_TOWARD_AUDIENCE);
    public static Pose2d RED_BACKDROP_CENTER = new Pose2d(2*TILE, -TILE-HALF_TILE, FACE_TOWARD_AUDIENCE);
    public static Pose2d RED_BACKDROP_LEFT = new Pose2d(2*TILE, -TILE-HALF_TILE+HALF_TILE, FACE_TOWARD_AUDIENCE);
