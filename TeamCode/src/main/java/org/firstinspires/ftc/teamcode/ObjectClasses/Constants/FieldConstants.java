...
public class FieldConstants {
    ...
    public static Pose2d RED_BACKSTAGE_SPIKE_C = new Pose2d(HALF_TILE, -TILE-HALF_TILE+1.2, FACE_TOWARD_BLUE);
    ...
    public static Pose2d BLUE_BACKSTAGE_SPIKE_R = new Pose2d(TILE-THREE_QUARTER_TILE-2, TILE+HALF_TILE-1, Math.toRadians(245));
    ...
    public static Pose2d RED_AUDIENCE_SPIKE_L = new Pose2d(-TILE-THREE_QUARTER_TILE, -TILE-HALF_TILE+5, FACE_135_DEGREES);
