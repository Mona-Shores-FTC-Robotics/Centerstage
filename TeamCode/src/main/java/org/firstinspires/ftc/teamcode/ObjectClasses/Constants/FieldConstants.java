...
public class FieldConstants {
    ...
    public static Pose2d BLUE_BACKDROP_RIGHT = new Pose2d(2*TILE, -TILE-HALF_TILE, FACE_TOWARD_AUDIENCE);
    public static Pose2d BLUE_BACKDROP_LEFT = new Pose2d(2*TILE, -TILE-HALF_TILE-EIGHTH_TILE, FACE_TOWARD_AUDIENCE);
